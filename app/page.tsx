          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            {isCategoriesVisible && (
              <div className="space-y-8 animate-fadeIn">
                ...
                <div className="hidden lg:flex justify-center items-center space-x-36 lg:space-x-44">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="relative overflow-hidden rounded-3xl navbar-hibrit-glass">
              ...
              <div className="relative z-10 py-16 px-8 text-center">
                ...
                <button className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 lg:px-8 lg:py-4 rounded-full text-base lg:text-lg font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform">
