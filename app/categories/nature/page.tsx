...
export default function NaturePage() {
  ...
  const wallpapers = [
    ...
    },
    {
      ...
      downloads: 2100,
      likes: 223,
      image: 'https://skiper-ui.com/images/x.com/19.jpeg',
    ...
    },
    {
      ...
      downloads: 2800,
      likes: 412,
      image: 'https://skiper-ui.com/images/x.com/1.jpeg',
      tags: ['cherry', 'blossom']
    }
  ];
  ...
  const filters = [
    ...
    { id: 'popular', name: 'Popular', count: wallpapers.filter(w => w.downloads > 2000).length },
  ...
  const filteredWallpapers = wallpapers.filter(wallpaper => {
    ...
    if (selectedFilter === 'popular') return wallpaper.downloads > 2000;
      ...
      <section className="pt-8 pb-12 lg:pt-16 lg:pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex items-center gap-2 text-sm text-apple-gray-600 dark:text-gray-400 mb-6">
            ...
            <span>/</span>
            <span className="text-apple-gray-900 dark:text-gray-200 font-medium">Nature</span>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12">
            ...
            <div className="relative">
              <div className="w-24 h-24 lg:w-32 lg:h-32 bg-gradient-to-br from-green-400 via-teal-400 to-blue-500 rounded-3xl flex items-center justify-center shadow-xl">
                <div className="text-white font-bold text-3xl lg:text-4xl">🌿</div>
              </div>
            ...
            <div className="flex-1">
              <h1 className="text-4xl lg:text-6xl font-bold text-apple-gray-900 dark:text-gray-100 mb-4">
                Nature <span className="bg-gradient-to-r from-green-400 via-teal-400 to-blue-500 bg-clip-text text-transparent">Collection</span>
              </h1>
              <p className="text-lg lg:text-xl text-apple-gray-600 dark:text-gray-300 mb-6 max-w-2xl">
                Immerse yourself in the pure beauty of nature with our fresh collection. From serene forests to majestic mountains, find peace in every wallpaper.
              </p>
              ...
              <div className="flex items-center gap-8 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-apple-gray-600 dark:text-gray-400">18 wallpapers</span>
                </div>
                <div className="flex items-center gap-2">
                  <Download className="w-4 h-4 text-apple-gray-500 dark:text-gray-500" />
                  <span className="text-apple-gray-600 dark:text-gray-400">15.2K downloads</span>
                </div>
                <div className="flex items-center gap-2">
                  <Heart className="w-4 h-4 text-red-500" />
                  <span className="text-apple-gray-600 dark:text-gray-400">1.8K likes</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
            {filteredWallpapers.map((wallpaper) => (
              <div key={wallpaper.id} className="group cursor-pointer">
                ...
                {/* Wallpaper Info */}
                <div className="pt-3">
                  <h3 className="font-semibold text-apple-gray-900 dark:text-gray-100 text-sm lg:text-base mb-1 group-hover:text-green-500 transition-colors">
                    {wallpaper.title}
                  </h3>
                  <div className="flex items-center justify-between">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-apple-gray-600 dark:text-gray-300">
              Explore similar categories that complement nature aesthetics
            </p>
          </div>

          {/* Related Categories Grid */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            <Link href="/categories/minimalist" className="group block">
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-400 via-gray-300 to-white aspect-[4/5] transition-all duration-300 group-hover:shadow-lg group-hover:scale-105">
                <div className="absolute inset-0 bg-black/10 group-hover:bg-black/5 transition-all duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-gray-800 font-bold text-xl lg:text-2xl">◯</div>
                </div>
                <div className="absolute bottom-3 left-3 right-3">
                  <div className="text-gray-800 text-xs font-medium opacity-90">21 wallpapers</div>
                </div>
              </div>
              <div className="pt-3">
            ...
            <Link href="/categories/90s-style" className="group block">
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-400 via-pink-400 to-orange-300 aspect-[4/5] transition-all duration-300 group-hover:shadow-lg group-hover:scale-105">
                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-all duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-white font-bold text-xl lg:text-2xl">90s</div>
                </div>
                <div className="absolute bottom-3 left-3 right-3">
                  <div className="text-white text-xs font-medium opacity-90">24 wallpapers</div>
                </div>
              </div>
              <div className="pt-3">
                <h3 className="font-semibold text-apple-gray-900 dark:text-gray-100 text-sm lg:text-base group-hover:text-purple-500 transition-colors">
                  90s Style
                </h3>
              </div>
            </Link>
